        ...
        match t{
            Toggle::FirstSwitch=>{
                if starting_state.first_switch{
                    res_state.second_switch = false;
                }
                res_state.first_switch = !res_state.first_switch;
                return res_state;
            },

            Toggle::SecondSwitch=>{
               res_state.second_switch = !starting_state.first_switch; 
                return res_state;
            }
        }
    }
